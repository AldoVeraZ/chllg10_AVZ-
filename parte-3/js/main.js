...
function Libreria(libros) {
  ...
  // Método para cargar elementos con libros en el destino especificado
  this.cargarElementoConLibros = function (id_destino) {
    ...
    if (elemLibrosContainer) {
      // Obtener el HTML de cada libro y unirlos en una cadena
      let htmlLibros = this.libros
        .map((libro) => libro.getHtmlArticle())
        .join("");

      // Agregar el HTML de los libros al contenedor
